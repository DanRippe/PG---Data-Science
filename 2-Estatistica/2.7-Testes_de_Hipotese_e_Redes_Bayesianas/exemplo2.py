...
print(f"\nProbabilidade a priori de ter a doença (P(D)): {P_D:.2%}")
...
print("\nApesar do sintoma, a doença ainda é rara, mas a probabilidade aumentou bastante em relação à probabilidade a priori.")